...
from model import Model0, Trainer
...
class Agent: 
    ...
    def get_state(self, game):
        ...
        state = [
            ...
            (dir_d and game.is_colision(point_l)) or 
            (dir_l and game.is_colision(point_u)) or 
            (dir_r and game.is_colision(point_d)),

            # Danger left
            (dir_d and game.is_colision(point_r)) or 
            (dir_u and game.is_colision(point_l)) or 
            (dir_r and game.is_colision(point_u)) or 
            (dir_l and game.is_colision(point_d)),
